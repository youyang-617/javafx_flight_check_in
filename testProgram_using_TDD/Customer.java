        ...
        while(check == 0){
            ...
            if(oneLine == null){
                ...
                if(customerInformation[5].equals(this.bookingNum)||(customerInformation[2].equals(this.idNum)&&customerInformation[1].equals(this.lastName))){
                    ...
                    System.out.println("This is "+this.lastName+" "+ this.firstName + ". S/He has "+this.carryOnPkgNum+" carry on package and "+this.checkInPkgNum+" check-in package.");
                }
                line++;
            }
                ...
                if (countline == line) {
                    ...
                    for (int i=0;i<length;i++){
                        ...
                        //Otherwise replace
                            ...
                            in_w.write(SeatNum);
                            if (seatNum.equals("1A")||seatNum.equals("1C")||seatNum.equals("1J")||seatNum.equals("1L")||seatNum.equals("2A")||seatNum.equals("2C")||seatNum.equals("2J")||seatNum.equals("2L"))
                            {
                                extrafeeSeat=323;
                            }
                            else
